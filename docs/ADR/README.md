...
The current visual acceptance decision for Object Analyze mode is [ADR-0025](0025-reference-image-as-binding-visual-acceptance-contract.md). The cross-surface design token system that all three surfaces resolve their appearance through is [ADR-0028](0028-unified-cross-surface-design-token-system.md), which reconciles the conflicting clauses in 0025 and 0026.
...
| [0025](0025-reference-image-as-binding-visual-acceptance-contract.md)   | Reference Image Is the Binding Visual Contract for Object Analyze Mode                   | Accepted                            |
